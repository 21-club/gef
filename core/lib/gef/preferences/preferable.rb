...
require 'gef/preferences/preferable_class_methods'
...
module Gef
  module Preferences
    ...
    # Examples:
    #
    #   # Gef::Base includes Preferable and defines preferences as a serialized
    #   # column.
    #   class Settings < Gef::Base
    ...
    module Preferable
      ...
      included do
        extend Gef::Preferences::PreferableClassMethods
      end
